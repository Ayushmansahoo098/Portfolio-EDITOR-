        ...
        <div className="glass-panel p-6 md:p-8 text-left border border-white/20 bg-black/40 backdrop-blur-xl rounded-lg">
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-4 mb-4 md:mb-8">
            <div className="bg-white/5 p-3 md:p-4 rounded-md text-center border border-white/5">
              <p className="text-2xl md:text-3xl font-display text-accentOrange mb-1">1.5</p>
              <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-textMuted text-balance">Years<br/>Experience</p>
            </div>
            <div className="bg-white/5 p-3 md:p-4 rounded-md text-center border border-white/5">
              <p className="text-2xl md:text-3xl font-display text-accentPurple mb-1">300+</p>
              <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-textMuted text-balance">Videos<br/>Delivered</p>
            </div>
            <div className="bg-white/5 p-3 md:p-4 rounded-md text-center border border-white/5">
